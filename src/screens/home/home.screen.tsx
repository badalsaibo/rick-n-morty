...
import LocationsTabScreen from './tab-screens/locations.tab';
...
const DEFAULT_TABS = [
  {
    name: 'CharactersTabScreen',
    component: CharacterTabScreen,
    tabBarLabel: 'Characters',
    iconSource: 'account-group',
  },
  {
    name: 'LocationsTabScreen',
    component: LocationsTabScreen,
    tabBarLabel: 'Locations',
    iconSource: 'earth',
  },
  {
    name: 'EpisodesTabScreen',
    component: EpisodesTabScreen,
    tabBarLabel: 'Episodes',
    iconSource: 'play-box-multiple',
  },
];
